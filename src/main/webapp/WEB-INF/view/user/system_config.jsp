        ...
        <div class="col-md-12">
            <form:form commandName="formDto" cssClass="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:input path="ssoCallbackUrl" cssClass="form-control" required="true"
                                    placeholder="Type SSO callback url"/>
                        <form:errors path="ssoCallbackUrl" cssClass="label label-warning"/>
                        <p class="help-block">Sprinter support IDP sso, must config IDP sso callback url:
                            /api/v1/pickup/userinfo/</p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:input path="ssoUsername" cssClass="form-control" required="true"
                                    placeholder="Type SSO username"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:password path="ssoPassword" id="ssoPassword" cssClass="form-control" required="true"
                                       placeholder="Type SSO password"/>
...
<script type="text/javascript">
    $(function () {
        $("#ssoPassword").val("${formDto.ssoPassword}");
    });
</script>
</body>
</html>
